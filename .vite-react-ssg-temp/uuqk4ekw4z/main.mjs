...
import { X, ChevronDown, Phone, Menu, ShieldCheck, Award, Wrench, Star, Clock, BadgeCheck, Zap, Shield, Sun, Eye, FlaskConical, Gem, Droplets, Atom, Sparkles, Layers, Armchair, Paintbrush, Waves, Settings, Cpu, ArrowLeft, ArrowRight, VolumeX, Volume2, MapPin, MessageCircle, Mail, CalendarCheck } from "lucide-react";
...
const Layout = () => /* @__PURE__ */ jsx(HelmetProvider, { children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxs(TooltipProvider, { children: [
                  ...
                  /* @__PURE__ */ jsx(AnimatePresence, { children: servicesOpen && /* @__PURE__ */ jsx(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxs("div", { className: "bg-background/95 backdrop-blur-xl border border-border/60 shadow-[0_20px_60px_hsl(0_0%_0%/0.5)] rounded-sm overflow-hidden", children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: "max-h-[60vh] overflow-y-auto", children: services$1.map((s) => /* @__PURE__ */ jsx(
                          Link,
                          {
                            to: `/services/${s.slug}`,
                            onClick: () => setServicesOpen(false),
...
const TrustBadges = () => {
  return /* @__PURE__ */ jsx("section", { className: "py-16 px-6 md:px-12 bg-secondary/50 border-y border-border", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: badges.map((badge, i) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
...
const Services = () => {
  return /* @__PURE__ */ jsx("section", { id: "services", className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: services.map((service, i) => {
...
const TrustSection = () => {
  return /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: trustItems.map((item, i) => /* @__PURE__ */ jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
...
const WorkshopGallery = () => {
  return /* @__PURE__ */ jsx("section", { id: "workshop", className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs(Carousel, { opts: { align: "start", loop: true }, className: "w-full", children: [
      /* @__PURE__ */ jsx(CarouselContent, { className: "-ml-4", children: images.map((img, i) => /* @__PURE__ */ jsx(CarouselItem, { className: "pl-4 md:basis-1/3", children: /* @__PURE__ */ jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
  ...
  return /* @__PURE__ */ jsx("footer", { className: "border-t border-border bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 md:px-12 py-16", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10 mb-12", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: ["Deep Interior Wash", "Ceramic Coating", "PPF Protection", "Car Restoration", "Teflon Coating"].map((s) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/#services", className: "text-sm text-muted-foreground hover:text-foreground transition-colors", children: s }) }, s)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2", children: [
          ...
          ["Workshop", "Testimonials", "Contact"].map((s) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: `/#${s.toLowerCase()}`, className: "text-sm text-muted-foreground hover:text-foreground transition-colors", children: s }) }, s)),
...
const BookAppointment = lazy(() => import("./assets/BookAppointment-DibP54tw.js"));
const Contact = lazy(() => import("./assets/Contact-1aEu1GyE.js"));
const ServicePage = lazy(() => import("./assets/ServicePage-CC8Exy3W.js"));
const PrivacyPolicy = lazy(() => import("./assets/PrivacyPolicy-Dqciyn46.js"));
const NotFound = lazy(() => import("./assets/NotFound-B8NgJ_7D.js"));
const AdminLogin = lazy(() => import("./assets/AdminLogin-n3tjBnVw.js"));
const AdminLayout = lazy(() => import("./assets/AdminLayout-lCp7slfN.js"));
const AdminDashboard = lazy(() => import("./assets/AdminDashboard-jbTaYGbl.js"));
const AdminAppointments = lazy(() => import("./assets/AdminAppointments-CqNq3fJS.js"));
const AdminContacts = lazy(() => import("./assets/AdminContacts-BSQKV2Re.js"));
const routes = [
  {
    path: "/",
    Component: Layout,
    children: [
      ...
      { path: "admin/login", Component: AdminLogin, entry: "spa" },
      {
        path: "admin",
