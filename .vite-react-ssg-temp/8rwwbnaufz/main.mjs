...
const adminChildren = isServer ? [] : [
  {
    path: "admin/login",
    Component: lazy(() => import("./assets/AdminLogin-BS35Qlnj.js"))
  },
  {
    path: "admin",
    Component: lazy(() => import("./assets/AdminLayout-BC5GnuZj.js")),
    children: [
      {
        index: true,
        Component: lazy(() => import("./assets/AdminDashboard-CyHkg_8T.js"))
      },
      {
        path: "appointments",
        Component: lazy(() => import("./assets/AdminAppointments-ih5e7mS0.js"))
      },
      {
        path: "contacts",
        Component: lazy(() => import("./assets/AdminContacts-BGkEms7j.js"))
      }
    ]
  }
];
const routes = [
  {
    ...
    children: [
      ...
      { path: "privacy-policy", Component: PrivacyPolicy, entry: "src/pages/PrivacyPolicy.tsx" },
      {
        ...
        getStaticPaths: () => servicePages.map((s) => `/services/${s.slug}`)
      },
      ...adminChildren,
