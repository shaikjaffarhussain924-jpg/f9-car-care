...
const adminChildren = isServer ? [] : [
  {
    path: "admin/login",
    Component: lazy(() => import("./assets/AdminLogin-_k9WA_A9.js"))
  },
  {
    path: "admin",
    Component: lazy(() => import("./assets/AdminLayout-CDSr0wcb.js")),
    children: [
      {
        index: true,
        Component: lazy(() => import("./assets/AdminDashboard-DALVQ7RC.js"))
      },
      {
        path: "appointments",
        Component: lazy(() => import("./assets/AdminAppointments-CITUwfRv.js"))
      },
      {
        path: "contacts",
        Component: lazy(() => import("./assets/AdminContacts-CGkgFrmA.js"))
      }
    ]
  }
];
