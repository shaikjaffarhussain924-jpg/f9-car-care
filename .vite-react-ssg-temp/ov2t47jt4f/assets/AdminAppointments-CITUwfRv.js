...
import { u as useToast, c as cn, B as Button } from "../main.mjs";
import { I as Input } from "./input-6XZgwDxx.js";
import { T as Textarea } from "./textarea-6Ttc-Vmm.js";
import { S as Sheet, a as SheetContent, b as SheetHeader, c as SheetTitle, W as WhatsAppThread } from "./WhatsAppThread-BVzUOSw9.js";
import { Search, Loader2, Calendar, Clock, Phone, MessageCircle, Save } from "lucide-react";
...
function AdminAppointments() {
  ...
  useEffect(() => {
    const channel = supabase.channel("appointments-live").on("postgres_changes", { event: "*", schema: "public", table: "appointments" }, () => load()).subscribe();
    return () => {
  ...
  const filtered = rows.filter((r) => {
    ...
    return r.name.toLowerCase().includes(s) || r.phone.includes(s) || (r.email ?? "").toLowerCase().includes(s) || (r.service ?? "").toLowerCase().includes(s);
  });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsx("h1", { className: "font-heading text-3xl md:text-4xl font-bold tracking-tight mb-6 animate-fade-in", children: "Appointments" }),
    ...
    loading ? /* @__PURE__ */ jsx("div", { className: "flex justify-center p-8", children: /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin text-muted-foreground" }) }) : filtered.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center text-muted-foreground py-16 bg-card rounded-2xl border border-border", children: "No appointments found" }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: filtered.map((r, i) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3 mb-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: cn("px-2.5 py-0.5 rounded-full text-xs font-medium", statusPillColor[r.status]), children: r.status })
            ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "text-sm text-foreground/80 mb-2", children: r.service ?? "—" }),
    ...
    /* @__PURE__ */ jsx(Sheet, { open: !!drawerRow, onOpenChange: (open) => !open && setDrawerRow(null), children: /* @__PURE__ */ jsx(SheetContent, { className: "w-full sm:max-w-[520px] flex flex-col p-0 gap-0", children: drawerRow && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(SheetHeader, { className: "p-6 pb-4 flex-row items-center justify-between space-y-0", children: /* @__PURE__ */ jsx(SheetTitle, { className: "text-xl font-heading", children: "Appointment Details" }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto px-6 pb-6 space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground mb-1", children: "Patient" }),
          /* @__PURE__ */ jsx("div", { className: "text-lg font-semibold", children: drawerRow.name })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsx(Field, { label: "Phone", value: /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 text-primary", children: [
            /* @__PURE__ */ jsx(Phone, { className: "w-3.5 h-3.5" }),
            " ",
            drawerRow.phone
          ] }) }),
          /* @__PURE__ */ jsx(Field, { label: "Email", value: drawerRow.email ?? "—" }),
          /* @__PURE__ */ jsx(Field, { label: "Service", value: drawerRow.service ?? "—" }),
          /* @__PURE__ */ jsx(Field, { label: "Doctor", value: drawerRow.doctor ?? "—" }),
          /* @__PURE__ */ jsx(Field, { label: "Date", value: drawerRow.preferred_date ?? "—" }),
          /* @__PURE__ */ jsx(Field, { label: "Time", value: drawerRow.preferred_time ?? "—" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground mb-2", children: "Status" }),
          /* @__PURE__ */ jsx("div", { className: "flex gap-2 flex-wrap", children: ["pending", "confirmed", "completed", "cancelled"].map((s) => /* @__PURE__ */ jsx(
            "button",
            {
        ...
        drawerRow.message && /* @__PURE__ */ jsxs("div", { className: "text-sm", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground mb-1.5", children: "Customer message" }),
