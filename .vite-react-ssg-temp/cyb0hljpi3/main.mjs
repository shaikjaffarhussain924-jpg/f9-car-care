...
const adminChildren = isServer ? [] : [
  {
    path: "admin/login",
    Component: lazy(() => import("./assets/AdminLogin-n3tjBnVw.js"))
  },
  {
    path: "admin",
    Component: lazy(() => import("./assets/AdminLayout-lCp7slfN.js")),
    children: [
      {
        index: true,
        Component: lazy(() => import("./assets/AdminDashboard-jbTaYGbl.js"))
      },
      {
        path: "appointments",
        Component: lazy(() => import("./assets/AdminAppointments-CqNq3fJS.js"))
      },
      {
        path: "contacts",
        Component: lazy(() => import("./assets/AdminContacts-BSQKV2Re.js"))
      }
    ]
  }
];
