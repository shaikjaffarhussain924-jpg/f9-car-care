...
import React__default, { Component, useState, useRef, useEffect, lazy } from "react";
import { jsx, jsxs, Fragment } from "react/jsx-runtime";
import { Outlet, useLocation, Link, useParams, Navigate } from "react-router-dom";
import * as ToastPrimitives from "@radix-ui/react-toast";
import { cva } from "class-variance-authority";
import { X, ChevronDown, Phone, Menu, ShieldCheck, Award, Wrench, Star, Clock, BadgeCheck, Zap, Shield, Sun, Eye, FlaskConical, Gem, Droplets, Atom, Sparkles, Layers, Armchair, Paintbrush, Waves, Settings, Cpu, ArrowLeft, ArrowRight, VolumeX, Volume2, MapPin, MessageCircle, Mail, CalendarCheck, ChevronLeft, ChevronRight, ChevronUp, Check, CalendarIcon, Loader2, Send, CheckCircle } from "lucide-react";
...
const whatsappLogo = "/assets/whatsapp-logo-CeWbSG4D.png";
const WhatsAppIcon = ({ className = "w-4 h-4" }) => /* @__PURE__ */ jsx("img", { src: whatsappLogo, alt: "WhatsApp", className: `${className} object-contain` });
const services$1 = [
...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxs(
    motion.nav,
    {
      ...
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-background/95 backdrop-blur-lg border-b border-border/50 shadow-[0_4px_30px_hsl(0_0%_0%/0.4)]" : "bg-background/80 backdrop-blur-md border-b border-border/20"}`,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto flex items-center justify-between px-6 md:px-12 h-20", children: [
          /* @__PURE__ */ jsxs(
            Link,
            {
              to: "/",
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-8 lg:gap-10", children: [
            /* @__PURE__ */ jsxs(
              "div",
              {
                ref: dropdownRef,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(AnimatePresence, { children: servicesOpen && /* @__PURE__ */ jsx(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxs("div", { className: "bg-background/95 backdrop-blur-xl border border-border/60 shadow-[0_20px_60px_hsl(0_0%_0%/0.5)] rounded-sm overflow-hidden", children: [
                        /* @__PURE__ */ jsx(
                          "a",
                          {
                        ...
                        /* @__PURE__ */ jsx("div", { className: "max-h-[60vh] overflow-y-auto", children: services$1.map((s2) => /* @__PURE__ */ jsx(
                          Link,
                          {
                            to: `/services/${s2.slug}`,
                            onClick: () => setServicesOpen(false),
            ...
            otherLinks.map((link) => /* @__PURE__ */ jsx(
              "a",
              {
                href: link.href,
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col px-6 py-6 gap-4", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  onClick: () => setMobileServicesOpen((s2) => !s2),
              ...
              /* @__PURE__ */ jsx(AnimatePresence, { children: mobileServicesOpen && /* @__PURE__ */ jsxs(
                motion.div,
                {
                  initial: { opacity: 0, height: 0 },
                  animate: { opacity: 1, height: "auto" },
                  ...
                  children: [
                    ...
                    services$1.map((s2) => /* @__PURE__ */ jsx(
                      Link,
                      {
                        to: `/services/${s2.slug}`,
                        onClick: () => setIsOpen(false),
...
const heroBg = "/assets/hero-bg-Bvzf8axN.jpg";
const Hero = () => {
  ...
  useEffect(() => {
    ...
    tryPlay();
    v2.addEventListener("loadedmetadata", tryPlay);
    v2.addEventListener("canplay", tryPlay);
    return () => {
      v2.removeEventListener("loadedmetadata", tryPlay);
      v2.removeEventListener("canplay", tryPlay);
    };
  }, []);
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-[100svh] flex items-center overflow-hidden bg-background pt-24 md:pt-28 pb-20", children: [
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-0 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-background/95 via-background/80 to-background/25 md:to-background/5" }),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/95 via-background/35 to-background/65" }),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_30%_50%,transparent_0%,hsl(var(--background)/0.55)_100%)]" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-20 w-full", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
          ...
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[10px] tracking-[0.35em] uppercase text-primary font-medium", children: "F9 Car Care & Detailing Studio" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            motion.h1,
            {
              ...
              children: [
                ...
                " ",
                /* @__PURE__ */ jsx("span", { className: "block mt-1 bg-gradient-to-r from-primary via-primary to-primary/70 bg-clip-text text-transparent", children: "| F9 Car Care" })
              ]
            }
          ),
          /* @__PURE__ */ jsx(
            motion.p,
            {
              ...
              children: "Complete car care solutions — from ceramic coating to full restoration. 20+ years of trusted craftsmanship in Hyderabad."
            }
          ),
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(motion.div, { whileHover: { scale: 1.02, y: -2 }, whileTap: { scale: 0.98 }, transition: { type: "spring", stiffness: 400, damping: 20 }, children: /* @__PURE__ */ jsxs(
                  Link,
                  {
                    to: "/book",
                    ...
                    children: [
                      /* @__PURE__ */ jsx("span", { className: "relative z-10", children: "Book Your Service" }),
                      /* @__PURE__ */ jsx("span", { className: "relative z-10 transition-transform duration-500 group-hover:translate-x-1", children: "→" })
                    ]
                  }
                ) }),
                /* @__PURE__ */ jsx(motion.div, { whileHover: { scale: 1.02, y: -2 }, whileTap: { scale: 0.98 }, transition: { type: "spring", stiffness: 400, damping: 20 }, children: /* @__PURE__ */ jsxs(
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-background to-transparent z-[5]" })
  ] });
};
const badges = [
...
const TrustBadges = () => {
  return /* @__PURE__ */ jsx("section", { className: "py-16 px-6 md:px-12 bg-secondary/50 border-y border-border", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsx(
    motion.div,
    {
      initial: { opacity: 0 },
      ...
      children: badges.map((badge, i2) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          transition: { duration: 0.5, delay: i2 * 0.08 },
          className: "flex flex-col items-center text-center group",
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-14 h-14 flex items-center justify-center border border-border bg-background mb-3 group-hover:border-primary/50 transition-colors duration-300", children: /* @__PURE__ */ jsx(badge.icon, { className: "w-6 h-6 text-primary" }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-foreground tracking-wide uppercase leading-tight", children: badge.label }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-1", children: badge.detail })
          ]
        },
        badge.label
      ))
...
const Services = () => {
  return /* @__PURE__ */ jsx("section", { id: "services", className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "font-heading text-3xl md:text-5xl font-bold text-foreground mb-4 tracking-tight", children: "Our Services" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg max-w-lg mx-auto", children: "Complete car care solutions for all models under one roof." })
        ]
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: services.map((service, i2) => {
      ...
      return /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          transition: { duration: 0.6, delay: i2 * 0.08 },
          className: "metallic-card p-8 group cursor-pointer",
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 flex items-center justify-center border border-border bg-background/50 mb-5 group-hover:border-primary/50 group-hover:shadow-[0_0_20px_hsl(45_100%_50%/0.15)] transition-all duration-500", children: /* @__PURE__ */ jsx(service.icon, { className: "w-6 h-6 text-primary group-hover:scale-110 transition-transform duration-500" }) }),
            /* @__PURE__ */ jsxs("h2", { className: "font-heading text-lg font-semibold text-foreground mb-3", children: [
              service.title,
              " in Hyderabad"
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-6", children: service.description }),
            /* @__PURE__ */ jsxs(
              Link,
              {
                to: linkTo,
                ...
                children: [
                  "Schedule Service",
                  /* @__PURE__ */ jsx("span", { className: "inline-block transition-transform duration-300 group-hover/link:translate-x-1", children: "→" })
                ]
              }
            )
          ]
...
const TrustSection = () => {
  return /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: trustItems.map((item, i2) => /* @__PURE__ */ jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
      viewport: { once: true },
      transition: { duration: 0.6, delay: i2 * 0.1 },
      className: "text-center py-8",
      children: [
        /* @__PURE__ */ jsx(item.icon, { className: "w-7 h-7 text-primary mx-auto mb-4" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground font-medium tracking-wide", children: item.label })
      ]
    },
    item.label
  )) }) }) });
...
const gallery1 = "/assets/gallery-1-BV5oDU16.webp";
const gallery2 = "/assets/gallery-2-C84q9-G1.webp";
const gallery3 = "/assets/gallery-3-Zfv4muw8.webp";
const gallery4 = "/assets/gallery-4-D17mp1Wm.webp";
const gallery5 = "/assets/gallery-5-CwSbCQyJ.webp";
const gallery6 = "/assets/gallery-6-DGFDbwkL.webp";
const images = [
...
const WorkshopGallery = () => {
  return /* @__PURE__ */ jsx("section", { id: "workshop", className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "luxury-divider mb-6" }),
          /* @__PURE__ */ jsx("h2", { className: "font-heading text-3xl md:text-5xl font-bold text-foreground mb-4 tracking-tight", children: "The Atelier" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg max-w-md mx-auto", children: "Where engineering meets artistry." })
        ]
      }
    ),
    /* @__PURE__ */ jsxs(Carousel, { opts: { align: "start", loop: true }, className: "w-full", children: [
      /* @__PURE__ */ jsx(CarouselContent, { className: "-ml-4", children: images.map((img, i2) => /* @__PURE__ */ jsx(CarouselItem, { className: "pl-4 md:basis-1/3", children: /* @__PURE__ */ jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          transition: { duration: 0.7, delay: i2 * 0.1 },
      ...
      /* @__PURE__ */ jsx(CarouselPrevious, { className: "-left-4 md:-left-12" }),
      /* @__PURE__ */ jsx(CarouselNext, { className: "-right-4 md:-right-12" })
    ] })
  ] }) });
};
const garwareImg = "/assets/garware-authorised-BbHMTbQW.jpg";
const GarwareAuthorised = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto px-4", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
...
function TestimonialCard({
  ...
  return /* @__PURE__ */ jsxs(
    Card2,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-md font-semibold leading-none", children: author.name }),
          author.handle && /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: author.handle })
        ] }) }),
        /* @__PURE__ */ jsx("p", { className: "sm:text-md mt-4 text-sm text-muted-foreground", children: text })
      ]
    }
  );
}
function TestimonialsSection({
  ...
  return /* @__PURE__ */ jsx("section", { className: cn(
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative flex w-full flex-col items-center justify-center overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "group flex overflow-hidden p-2 [--gap:1rem] [gap:var(--gap)] flex-row [--duration:600s]", children: /* @__PURE__ */ jsx("div", { className: "flex shrink-0 justify-around [gap:var(--gap)] animate-marquee flex-row group-hover:[animation-play-state:paused]", children: [...Array(4)].map((_2, setIndex) => testimonials2.map((testimonial, i2) => /* @__PURE__ */ jsx(
        TestimonialCard,
        {
          ...testimonial
        },
...
const Testimonials = () => {
  return /* @__PURE__ */ jsx("section", { id: "testimonials", children: /* @__PURE__ */ jsx(
    TestimonialsSection,
    {
...
const LocationSection = () => {
  return /* @__PURE__ */ jsx("section", { id: "contact", className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "luxury-divider mb-6" }),
          /* @__PURE__ */ jsx("h2", { className: "font-heading text-3xl md:text-5xl font-bold text-foreground mb-4 tracking-tight", children: "Visit the Atelier" })
        ]
      }
    ),
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsx(MapPin, { className: "w-5 h-5 text-primary mt-1 shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: "Workshop Address" }),
                /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
                  "Near Gopal Nagar Kamaan, Beside Line F9 Pharmacy,",
                  /* @__PURE__ */ jsx("br", {}),
                  "Manjeera Pipeline Road, Gopal Nagar,",
                  /* @__PURE__ */ jsx("br", {}),
                  "Hyderabad - 500085"
                ] })
              ] })
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsx(Phone, { className: "w-5 h-5 text-primary mt-1 shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: "Phone" }),
                /* @__PURE__ */ jsx("a", { href: "tel:+917032674047", className: "text-sm text-muted-foreground hover:text-foreground transition-colors block", children: "+91 70326 74047" }),
                /* @__PURE__ */ jsx("a", { href: "tel:+918499966614", className: "text-sm text-muted-foreground hover:text-foreground transition-colors block", children: "+91 84999 66614" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsx(MessageCircle, { className: "w-5 h-5 text-primary mt-1 shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: "WhatsApp" }),
                /* @__PURE__ */ jsx(
                  "a",
                  {
                    ...
                    children: "Chat with our concierge"
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsx(Mail, { className: "w-5 h-5 text-primary mt-1 shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: "Email" }),
                /* @__PURE__ */ jsx(
                  "a",
                  {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsx(Clock, { className: "w-5 h-5 text-primary mt-1 shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: "Working Hours" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Mon - Sat: 9:00 AM - 7:00 PM" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Sunday: By Appointment" })
              ] })
            ] })
          ]
        }
...
const Footer = () => {
  return /* @__PURE__ */ jsx("footer", { className: "border-t border-border bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 md:px-12 py-16", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10 mb-12", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs(Link, { to: "/", className: "font-heading text-lg font-bold tracking-[0.2em] uppercase text-foreground mb-4 block", children: [
          "F9 Car Care",
          /* @__PURE__ */ jsx("span", { className: "text-primary", children: "." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4", children: "Premium car care & detailing studio with 20+ years of experience in Hyderabad." }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxs("a", { href: "tel:+917032674047", className: "text-sm text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Phone, { className: "w-3.5 h-3.5" }),
            " +91 70326 74047"
          ] }),
          /* @__PURE__ */ jsxs("a", { href: "mailto:support@f9carcare.co.in", className: "text-sm text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs tracking-[0.15em] uppercase font-semibold text-foreground mb-4", children: "Services" }),
        /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: ["Deep Interior Wash", "Ceramic Coating", "PPF Protection", "Car Restoration", "Teflon Coating"].map((s2) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/#services", className: "text-sm text-muted-foreground hover:text-foreground transition-colors", children: s2 }) }, s2)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs tracking-[0.15em] uppercase font-semibold text-foreground mb-4", children: "Company" }),
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/book", className: "text-sm text-muted-foreground hover:text-foreground transition-colors", children: "Book Appointment" }) }),
          ["Workshop", "Testimonials", "Contact"].map((s2) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: `/#${s2.toLowerCase()}`, className: "text-sm text-muted-foreground hover:text-foreground transition-colors", children: s2 }) }, s2)),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/privacy-policy", className: "text-sm text-muted-foreground hover:text-foreground transition-colors", children: "Privacy Policy" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs tracking-[0.15em] uppercase font-semibold text-foreground mb-4", children: "Location" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(MapPin, { className: "w-4 h-4 text-primary mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Near Gopal Nagar Kamaan, Beside Line F9 Pharmacy, Manjeera Pipeline Road, Gopal Nagar, Hyderabad - 500085" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "border-t border-border pt-8", children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground text-center", children: "© 2026 F9 Car Care & Detailing Studio. All rights reserved." }) })
  ] }) });
};
const FloatingCTA = () => {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsx("img", { src: whatsappLogo, alt: "WhatsApp", className: "w-full h-full object-cover" })
          }
        ),
        /* @__PURE__ */ jsxs(
          Link,
...
const Index = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(W, { children: [
      /* @__PURE__ */ jsx("title", { children: "F9 Car Care – Professional Detailing & Car Wash" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "F9 Car Care offers professional car detailing, full wash, and maintenance services. Easy online booking. Fast, reliable, and trusted." }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://www.f9carcare.co.in/" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "F9 Car Care – Professional Detailing & Car Wash" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "F9 Car Care offers professional car detailing, full wash, and maintenance services. Easy online booking. Fast, reliable, and trusted." }),
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: "https://www.f9carcare.co.in/" }),
    ...
    /* @__PURE__ */ jsx(WorkshopGallery, {}),
    /* @__PURE__ */ jsx(GarwareAuthorised, {}),
...
const BookingForm = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setRedirectCountdown((c2) => c2 > 0 ? c2 - 1 : 0);
    }, 1e3);
    const timeout = setTimeout(() => {
              ...
              /* @__PURE__ */ jsxs(CardContent, { className: "space-y-5", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
                  /* @__PURE__ */ jsxs(motion.div, { variants: fadeInUp, className: "space-y-2", children: [
                    ...
                    /* @__PURE__ */ jsxs(
                      ...
                      {
                        value: form.brand,
                        onValueChange: (v2) => updateField("brand", v2),
                        children: [
                          /* @__PURE__ */ jsx(SelectTrigger, { id: "brand", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select brand" }) }),
                          /* @__PURE__ */ jsx(SelectContent, { position: "popper", side: "bottom", sideOffset: 4, avoidCollisions: false, children: carBrands.map((b2) => /* @__PURE__ */ jsx(SelectItem, { value: b2, children: b2 }, b2)) })
                        ]
                      }
                    )
                  ] }),
                ...
                /* @__PURE__ */ jsxs(motion.div, { variants: fadeInUp, className: "space-y-2", children: [
                  ...
                  /* @__PURE__ */ jsxs(
                    ...
                    {
                      value: form.service,
                      onValueChange: (v2) => updateField("service", v2),
                      children: [
                        /* @__PURE__ */ jsx(SelectTrigger, { id: "service", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select a service" }) }),
                        /* @__PURE__ */ jsx(SelectContent, { position: "popper", side: "bottom", sideOffset: 4, avoidCollisions: false, children: serviceTypes.map((s2) => /* @__PURE__ */ jsx(SelectItem, { value: s2, children: s2 }, s2)) })
                      ]
                    }
                  )
                ] }),
                    ...
                    /* @__PURE__ */ jsxs(Popover, { children: [
                      ...
                      /* @__PURE__ */ jsx(PopoverContent, { className: "w-auto p-0", align: "start", children: /* @__PURE__ */ jsx(
                        Calendar,
                        {
                          ...
                          onSelect: (d2) => updateField("date", d2 ? format(d2, "yyyy-MM-dd") : ""),
                          disabled: (d2) => {
...
function Contact() {
  ...
  const submit = async (e) => {
    ...
    if (!form.name.trim() || !form.message.trim()) {
      toast2({ title: "Please fill name and message", variant: "destructive" });
      return;
    }
    setBusy(true);
    ...
    setBusy(false);
    if (error) {
      toast2({ title: "Could not send", description: error.message, variant: "destructive" });
      return;
    }
    setDone(true);
    toast2({ title: "Message sent ✓", description: "We'll get back to you shortly." });
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(W, { children: [
...
const renderInline = (text, keyBase) => {
  ...
  while ((match = regex.exec(text)) !== null) {
    ...
    const tok = match[0];
    const k2 = `${keyBase}-${i2++}`;
    if (tok.startsWith("**")) nodes.push(/* @__PURE__ */ jsx("strong", { children: tok.slice(2, -2) }, k2));
    else if (tok.startsWith("`")) nodes.push(/* @__PURE__ */ jsx("code", { children: tok.slice(1, -1) }, k2));
    else if (tok.startsWith("[")) {
      const m2 = /\[([^\]]+)\]\(([^)]+)\)/.exec(tok);
      nodes.push(
        /* @__PURE__ */ jsx("a", { href: m2[2], className: "underline", children: m2[1] }, k2)
      );
    } else nodes.push(/* @__PURE__ */ jsx("em", { children: tok.slice(1, -1) }, k2));
...
const RawMarkdown = ({ source }) => {
  ...
  while (i2 < lines.length) {
    ...
    const h2 = /^(#{1,6})\s+(.*)$/.exec(line);
    if (h2) {
      const level = h2[1].length;
      const txt = h2[2].replace(/^H\d:\s*/i, "");
    ...
    if (/^>\s?/.test(line)) {
      ...
      while (i2 < lines.length && /^>\s?/.test(lines[i2])) {
        buf2.push(lines[i2].replace(/^>\s?/, ""));
        i2++;
      }
      blocks.push(
        /* @__PURE__ */ jsx("div", { className: "my-4 pl-4 border-l-2 border-border text-muted-foreground space-y-2", children: buf2.map((b2, bi) => /* @__PURE__ */ jsx("p", { children: renderInline(b2, `bq${key}-${bi}`) }, bi)) }, key++)
      );
      continue;
    }
    if (/^\s*[-*+]\s+/.test(line)) {
    ...
    if (/^\s*\|.*\|\s*$/.test(line)) {
      const rows = [];
      while (i2 < lines.length && /^\s*\|.*\|\s*$/.test(lines[i2])) {
        const cells = lines[i2].trim().slice(1, -1).split("|").map((c2) => c2.trim());
        rows.push(cells);
        i2++;
      }
      const filtered = rows.filter((r2) => !r2.every((c2) => /^:?-{2,}:?$/.test(c2)));
      blocks.push(
        /* @__PURE__ */ jsx("div", { className: "my-4 space-y-2", children: filtered.map((r2, ri) => /* @__PURE__ */ jsx("p", { children: renderInline(r2.join(" — "), `tr${key}-${ri}`) }, ri)) }, key++)
      );
      continue;
    }
    if (/^```/.test(line)) {
      const buf2 = [];
      i2++;
      while (i2 < lines.length && !/^```/.test(lines[i2])) {
        buf2.push(lines[i2]);
        i2++;
      }
      if (i2 < lines.length) i2++;
      blocks.push(
    ...
    const buf = [];
    while (i2 < lines.length && !/^\s*$/.test(lines[i2]) && !/^#{1,6}\s+/.test(lines[i2]) && !/^>\s?/.test(lines[i2]) && !/^\s*[-*+]\s+/.test(lines[i2]) && !/^\s*\d+\.\s+/.test(lines[i2]) && !/^\s*\|.*\|\s*$/.test(lines[i2]) && !/^```/.test(lines[i2]) && !/^---+\s*$/.test(lines[i2])) {
      buf.push(lines[i2]);
      i2++;
    }
    blocks.push(
...
const ServiceDetailPage = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "pt-20", children: [
    ...
    data.benefits.length > 0 && /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: data.benefits.map((b2, i2) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          transition: { delay: i2 * 0.08 },
          className: "metallic-card p-6",
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 flex items-center justify-center border border-border bg-background/50 mb-4", children: /* @__PURE__ */ jsx(b2.icon, { className: "w-5 h-5 text-primary" }) }),
            /* @__PURE__ */ jsx("h3", { className: "font-heading text-base font-semibold text-foreground mb-2", children: b2.title }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: b2.description })
          ]
        },
        b2.title
      )) })
    ...
    data.checklist && data.checklist.length > 0 && /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: data.checklist.map((item, i2) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, x: -10 },
          whileInView: { opacity: 1, x: 0 },
          viewport: { once: true },
          transition: { delay: i2 * 0.05 },
    ...
    data.materials && data.materials.length > 0 && /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: data.materials.map((m2, i2) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          ...
          className: "metallic-card p-6",
          children: [
            /* @__PURE__ */ jsx("h3", { className: "font-heading text-base font-semibold text-foreground mb-2", children: m2.title }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: m2.description })
          ]
        },
        m2.title
      )) })
    ...
    data.process && data.process.length > 0 && /* @__PURE__ */ jsx("section", { className: "section-padding bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-4", children: data.process.map((s2, i2) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, x: -20 },
          whileInView: { opacity: 1, x: 0 },
          ...
          children: [
            /* @__PURE__ */ jsx("span", { className: "font-heading text-2xl font-bold text-primary w-10 text-center shrink-0", children: s2.step }),
            /* @__PURE__ */ jsx("span", { className: "text-foreground font-medium", children: s2.title })
          ]
        },
        s2.step
      )) })
    ...
    data.comparison && /* @__PURE__ */ jsx("section", { className: "section-padding bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "border border-border overflow-hidden", children: [
        ...
        data.comparison.rows.map((row, i2) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 border-t border-border", children: [
    ...
    data.richContent && data.richContent.length > 0 && data.richContent.map((section, idx) => /* @__PURE__ */ jsx("section", { className: `section-padding ${idx % 2 === 0 ? "bg-secondary/30" : "bg-background"}`, children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          section.paragraphs.map((p2, pi) => /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed text-base md:text-lg mb-4 last:mb-0", children: p2 }, pi)),
    ...
    /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: `grid grid-cols-1 md:grid-cols-${data.pricing.length > 3 ? "2 lg:grid-cols-4" : data.pricing.length} gap-6`, children: data.pricing.map((p2, i2) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          transition: { delay: i2 * 0.1 },
          className: `metallic-card p-8 text-center relative ${p2.popular ? "border-primary/50" : ""}`,
          children: [
            p2.popular && /* @__PURE__ */ jsx("span", { className: "absolute -top-3 left-1/2 -translate-x-1/2 text-[10px] tracking-[0.15em] uppercase bg-primary text-primary-foreground px-4 py-1 font-medium", children: "Most Popular" }),
            /* @__PURE__ */ jsx("h3", { className: "font-heading text-lg font-semibold text-foreground mb-3", children: p2.title }),
            /* @__PURE__ */ jsx("p", { className: "font-heading text-3xl font-bold text-primary mb-3", children: p2.price }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: p2.description })
          ]
        },
        p2.title
      )) }),
    ...
    /* @__PURE__ */ jsx("section", { className: "section-padding bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "space-y-3", children: data.faqs.map((faq, i2) => /* @__PURE__ */ jsxs(
        AccordionItem,
        {
          value: `faq-${i2}`,
...
const ServicePage = () => {
  ...
  const data = servicePages.find((s2) => s2.slug === slug);
...
const adminChildren = isServer ? [] : [
  {
    path: "admin/login",
    Component: lazy(() => import("./assets/AdminLogin-CHZVlNKQ.js"))
  },
  {
    path: "admin",
    Component: lazy(() => import("./assets/AdminLayout-BX3YeQJC.js")),
    children: [
      {
        index: true,
        Component: lazy(() => import("./assets/AdminDashboard-CcM7MCVH.js"))
      },
      {
        path: "appointments",
        Component: lazy(() => import("./assets/AdminAppointments-41XH1PkA.js"))
      },
      {
        path: "contacts",
        Component: lazy(() => import("./assets/AdminContacts-CB2y4t2F.js"))
      }
    ]
  }
];
const routes = [
  {
    ...
    children: [
      ...
      { path: "privacy-policy", Component: PrivacyPolicy, entry: "src/pages/PrivacyPolicy.tsx" },
      {
        ...
        getStaticPaths: () => servicePages.map((s2) => `/services/${s2.slug}`)
      },
      ...adminChildren,
