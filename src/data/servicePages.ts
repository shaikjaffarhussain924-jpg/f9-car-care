...
export const servicePages: ServicePageData[] = [
  ...
  {
  {
    ...
    tags: ["9H Hardness", "SiO2 Nano Tech", "Hydrophobic", "UV Resistant", "5-Year Durability"],
    aboutTitle: "",
    aboutBody: "",
    benefitsTitle: "",
    benefits: [],
    ...
    faqs: [
      { question: "What is nano coating and is it the same as ceramic coating?", answer: "Nano coating uses nanoparticle-sized SiO2/TiO2 particles to create a protective surface layer. Professional-grade nano coating with 9H hardness is what others typically call ceramic coating. At F9 Car Care our nano coating delivers performance comparable to premium ceramic coating." },
      { question: "How long does nano coating last in Hyderabad?", answer: "Our Essential package delivers 12–18 months, Premium delivers 2–3 years, and Elite delivers 3–5 years of comprehensive protection — depending on product specification, application quality, and maintenance." },
      { question: "Does nano coating make my car completely scratch-proof?", answer: "No coating is scratch-proof. Nano coating significantly increases resistance to micro-scratches, swirl marks, and light abrasion. Deep key scratches or stone chips will still penetrate any coating — for that level of protection choose PPF, which we also offer." },
      { question: "How much does nano coating cost in Hyderabad?", answer: "Pricing varies by vehicle size and package. Essential for hatchbacks starts at a budget-friendly point; Elite for luxury vehicles reflects extensive prep and premium products. Contact us for a transparent vehicle-specific quote — no hidden charges." },
      { question: "How is nano coating different from Teflon coating?", answer: "Teflon (PTFE) achieves only 2H–4H hardness and lasts 6–12 months. Nano coating delivers 9H hardness and 2–5 years of protection with superior hydrophobic and UV performance. Nano chemically bonds with the paint; Teflon sits on top." },
      { question: "Do I need paint correction before nano coating?", answer: "Yes — ideally. Coating locks whatever is underneath it in place permanently. Our Premium and Elite packages include multi-stage paint correction. The Essential package includes a polishing stage for cars in reasonable condition." },
      { question: "Can I use automatic car washes after nano coating?", answer: "No. Automatic brush washes cause heavy swirl marks and damage coatings over time. Use touchless high-pressure washes or hand wash with the two-bucket method and pH-neutral shampoo." },
      { question: "How long does the nano coating process take?", answer: "Essential takes 6–8 hours (same-day). Premium takes 1–2 days for paint correction and multiple coating layers. Elite takes 2–3 days for extensive multi-stage correction. You'll receive regular WhatsApp updates with progress photos." },
      { question: "Is nano coating worth it for an older car?", answer: "Absolutely. Older cars often show the most dramatic transformation because paint correction addresses oxidation, swirl marks, and fading before sealing in the restored finish." },
      { question: "Nano coating vs PPF — which should I choose?", answer: "Nano coating protects against chemical damage, UV, water spots, and micro-scratches with a mirror finish. PPF is a physical urethane film that absorbs stone chips, deep scratches, and impacts. Many owners combine both — PPF on high-impact panels, nano coating everywhere else." },
    ],
